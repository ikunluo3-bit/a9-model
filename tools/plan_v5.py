...
CARS={
 "三菱":("三菱 Lancer Evolution",0x1CE90,"轨道压路机",260.0, 88000.0,1.05,1.00,0.60),
 "Z4": ("宝马 Z4 LCI E89",      0x1933C,"翘头刀",    260.0, 88000.0,1.05,1.00,0.45),
 "370Z":("日产 370Z",           0x19BB0,"轻量刀锋",  260.0,100000.0,1.05,1.00,0.50),
 "拉法":("法拉利 LaFerrari",    0x1FBEC,"全能旗舰",  330.0, 88000.0,1.10,1.00,0.50),
}
...
ap.add_argument("--out",default=r"C:\Users\player\Desktop\a9模型\tuned-v5")
a=ap.parse_args()
