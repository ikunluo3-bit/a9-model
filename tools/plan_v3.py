...
CARS={
 "三菱":("三菱 Lancer Evolution",0x1CE90,"轨道压路机 · 稳到底",
        dict(f76=0.60,f77=1.00, damp=0.60, steer=72000.0, gs=285.0, grip=1.00)),
 "Z4": ("宝马 Z4 LCI E89",      0x1933C,"翘头刀 · 又灵又爱抬",
        dict(f76=0.60,f77=1.00, damp=0.45, steer=72000.0, gs=285.0, grip=1.00)),
 "370Z":("日产 370Z",           0x19BB0,"轻量刀锋 · 全场最灵",
        dict(f76=0.60,f77=1.00, damp=0.50, steer=80000.0, gs=285.0, grip=1.00)),
 "拉法":("法拉利 LaFerrari",    0x1FBEC,"全能旗舰 · 均衡无短板",
        dict(f76=0.60,f77=1.00, damp=0.50, steer=72000.0, gs=285.0, grip=1.05)),
}
...
ap.add_argument("--out",default=r"C:\Users\player\Desktop\a9模型\tuned-v3")
a=ap.parse_args()
